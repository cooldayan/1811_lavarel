  ...
  <body>
    <div class="maincont">
     ...
     @foreach($data as $val)
            ...
            <img src="http://www.up.com/{{ $goodsInfo -> goods_img }}" /></a>
      @endforeach
     </div><!--sliderA/-->
     <table class="jia-len">
      <tr>
     ...
     <div class="zhaieq">
      ...
      <a href="javascript:;">评论添加</a>
      <a href="javascript:;" style="background:none;">评论列表</a>
      <div class="clearfix"></div>
     </div><!--zhaieq/-->
     <div class="proinfoList">
      <img src="http://www.up.com/{{ $goodsInfo -> goods_img }}" width="636" height="822" />
     </div><!--proinfoList/-->
     <div class="proinfoList">
      <p>
      用户名：
      ...
      <p>
      e-mail：
      <input type="text" name='p_email' id="email">
      </p>
      <p>
      评价等级：
      <input type="radio" name="p_lv" value='1星' id="">⭐
      <input type="radio" name="p_lv" value='2星' id="">⭐⭐
      <input type="radio" name="p_lv" value='3星' id="">⭐⭐⭐
      <input type="radio" name="p_lv" value='4星' id="">⭐⭐⭐⭐
      <input type="radio" name="p_lv" value='5星' id="">⭐⭐⭐⭐⭐
      </p>
      <p>
      评论内容：
      <textarea name="p_desc" id="desc" cols="30" rows="10"></textarea>
      </p>
      <p>
         <button id="pt">提交</button>
      </p>
     </div><!--proinfoList/-->
     <div class="proinfoList" id="con">
...
$('#pt').click(function(){
    ...
    $.ajaxSetup({
            ...
            $.post(
                "{{route('addBuys')}}",
                {p_email:p_email,p_lv:p_lv,p_desc:p_desc},
                function(res){
                    if(res.code==1){
                        alert(res.msg);
                    }
