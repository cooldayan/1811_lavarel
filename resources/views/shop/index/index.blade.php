...
@section('content')
     ...
     <div id="sliderA" class="slider">
      <!-- 轮播图 -->
      @foreach($max as $val)
            <a href="{{route('proInfo',['goods_id'=>$val->goods_id])}}"><img src="http://www.up.com/{{ $val -> goods_img }}" /></a>
      @endforeach
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{route('proInfo',['goods_id'=>$val->goods_id])}}"><img src="http://www.up.com/{{ $val -> goods_img }}" style="width:293px;height:299px" /></a></dt>
     ...
     @foreach($data as $val)
      <dl>
       <dt><a href="{{route('proInfo',['goods_id'=>$val->goods_id])}}"><img src="http://www.up.com/{{ $val -> goods_img }}" width="100" height="100" /></a></dt>
       <dd>
